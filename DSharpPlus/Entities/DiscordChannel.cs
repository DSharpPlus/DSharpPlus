...
namespace DSharpPlus.Entities
{
    ...
    public class DiscordChannel : SnowflakeObject, IEquatable<DiscordChannel>
    {
        ...
        /// <param name="before">Message ID to fetch before from.</param>
        /// </summary> 
        ...
        /// <param name="limit">The amount of messages to fetch, up to a maximum of 100</param>
        /// <param name="after">Message ID to fetch after from.</param>
        /// </summary> 
        ...
        /// <param name="limit">The amount of messages to fetch, up to a maximum of 100</param>
        /// <param name="around">Message ID to fetch around from.</param>
        /// </summary> 
