...
internal static class SlashLogging
{
    ...
    internal static readonly Action<ILogger, int, int, Exception?> detectedCommandRecordChanges = LoggerMessage.Define<int, int>(LogLevel.Information, default, "Detected changes in slash command records: {Added} added, {Edited} edited - bulk-overwriting to update remote records");
}
