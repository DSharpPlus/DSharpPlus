...
namespace DSharpPlus.Entities
{
    ...
    public class DiscordChannel : SnowflakeObject, IEquatable<DiscordChannel>
    {
        ...
        public Task<DiscordMessage> SendMessageAsync(string content = null, bool tts = false, DiscordEmbed embed = null, IEnumerable<IMention> mentions = null, ulong? message_id = null)
        {
            ...
            return this.Discord.ApiClient.CreateMessageAsync(this.Id, content, tts, embed, mentions, message_id);
        }
