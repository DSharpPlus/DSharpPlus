...
public sealed class ArgumentParseException : CommandsException
{
    ...
    public ArgumentParseException(CommandParameter parameter, ArgumentFailedConversionResult? conversionResult = null, string? message = null) : base(message ?? $"Failed to parse {parameter.Name}.", conversionResult?.Error)
    {
