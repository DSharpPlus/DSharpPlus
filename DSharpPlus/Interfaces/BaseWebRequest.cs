...
namespace DSharpPlus
{
    ...
    public abstract class BaseWebRequest
    {
        ...
        protected internal TaskCompletionSource<WebResponse> RequestTaskSource { get; }
        ...
        /// <summary>
        /// Creates a new <see cref="BaseWebRequest"/> with specified parameters.
        /// </summary>
        ...
        internal BaseWebRequest(DiscordClient client, RateLimitBucket bucket, Uri url, HttpRequestMethod method, IDictionary<string, string> headers = null)
        {
            this.Discord = client;
            this.RateLimitBucket = bucket;
            this.RequestTaskSource = new TaskCompletionSource<WebResponse>();
            this.Url = url;
            this.Method = method;
        ...
        public Task<WebResponse> WaitForCompletionAsync() =>
            this.RequestTaskSource.Task;

        protected internal void SetCompleted(WebResponse response) =>
