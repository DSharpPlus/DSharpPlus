...
namespace DSharpPlus
{
    ...
    public class DiscordMessage : SnowflakeObject
    {
        ...
        /// </summary>
        [JsonIgnore]
        public DiscordChannel Parent => DiscordClient.GetGuildIdFromChannelID(ChannelID) == 0? DiscordClient._privateChannels.Find(x => x.ID == ChannelID) : DiscordClient._guilds[DiscordClient.GetGuildIdFromChannelID(ChannelID)].Channels.Find(x => x.ID == ChannelID) ;
        /// <summary>
