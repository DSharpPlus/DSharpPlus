...
public class Int8Converter : IArgumentConverter<sbyte>
{
    ...
    {
        return sbyte.TryParse(value, NumberStyles.Integer, ctx.CommandsNext.DefaultParserCulture, out sbyte result)
            ? Task.FromResult(Optional.FromValue(result))
...
public class Uint8Converter : IArgumentConverter<byte>
{
    ...
    {
        return byte.TryParse(value, NumberStyles.Integer, ctx.CommandsNext.DefaultParserCulture, out byte result)
            ? Task.FromResult(Optional.FromValue(result))
...
public class Int16Converter : IArgumentConverter<short>
{
    ...
    {
        return short.TryParse(value, NumberStyles.Integer, ctx.CommandsNext.DefaultParserCulture, out short result)
            ? Task.FromResult(Optional.FromValue(result))
...
public class Uint16Converter : IArgumentConverter<ushort>
{
    ...
    {
        return ushort.TryParse(value, NumberStyles.Integer, ctx.CommandsNext.DefaultParserCulture, out ushort result)
            ? Task.FromResult(Optional.FromValue(result))
...
public class Int32Converter : IArgumentConverter<int>
{
    ...
    {
        return int.TryParse(value, NumberStyles.Integer, ctx.CommandsNext.DefaultParserCulture, out int result)
            ? Task.FromResult(Optional.FromValue(result))
...
public class Uint32Converter : IArgumentConverter<uint>
{
    ...
    {
        return uint.TryParse(value, NumberStyles.Integer, ctx.CommandsNext.DefaultParserCulture, out uint result)
            ? Task.FromResult(Optional.FromValue(result))
...
public class Int64Converter : IArgumentConverter<long>
{
    ...
    {
        return long.TryParse(value, NumberStyles.Integer, ctx.CommandsNext.DefaultParserCulture, out long result)
            ? Task.FromResult(Optional.FromValue(result))
...
public class Uint64Converter : IArgumentConverter<ulong>
{
    ...
    {
        return ulong.TryParse(value, NumberStyles.Integer, ctx.CommandsNext.DefaultParserCulture, out ulong result)
            ? Task.FromResult(Optional.FromValue(result))
...
public class Float32Converter : IArgumentConverter<float>
{
    ...
    {
        return float.TryParse(value, NumberStyles.Number, ctx.CommandsNext.DefaultParserCulture, out float result)
            ? Task.FromResult(Optional.FromValue(result))
...
public class Float64Converter : IArgumentConverter<double>
{
    ...
    {
        return double.TryParse(value, NumberStyles.Number, ctx.CommandsNext.DefaultParserCulture, out double result)
            ? Task.FromResult(Optional.FromValue(result))
...
public class Float128Converter : IArgumentConverter<decimal>
{
    ...
    {
        return decimal.TryParse(value, NumberStyles.Number, ctx.CommandsNext.DefaultParserCulture, out decimal result)
            ? Task.FromResult(Optional.FromValue(result))
