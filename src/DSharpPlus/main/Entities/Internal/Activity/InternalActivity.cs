...
namespace DSharpPlus.Core.Entities
{
    public sealed record InternalActivity
    {
        ...
        public InternalActivityType Type { get; init; }

        /// <summary>
        /// The stream url, is validated when type is <see cref="InternalActivityType.Streaming"/>.
        /// </summary>
        ...
        /// <summary>
        /// <see cref="InternalActivityFlags"/> <c>OR</c>'d together, describes what the payload includes.
        /// </summary>
        [JsonPropertyName("flags")]
        public Optional<InternalActivityFlags> Flags { get; init; }
