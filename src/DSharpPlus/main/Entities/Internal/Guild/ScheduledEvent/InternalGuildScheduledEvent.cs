...
namespace DSharpPlus.Core.Entities
{
    ...
    /// </summary>
    [InternalGatewayPayload("GUILD_SCHEDULED_EVENT_CREATE", "GUILD_SCHEDULED_EVENT_UPDATE", "GUILD_SCHEDULED_EVENT_DELETE")]
    public sealed record InternalGuildScheduledEvent
    {
        ...
        public InternalGuildScheduledEventPrivacyLevel PrivacyLevel { get; init; }

        /// <summary>
        /// The status of the scheduled event.
        /// </summary>
        [JsonPropertyName("status")]
        public InternalGuildScheduledEventStatus Status { get; init; }

        /// <summary>
        /// The type of the scheduled event
        /// </summary>
        [JsonPropertyName("entity_type")]
        public InternalGuildScheduledEventEntityType EntityType { get; init; }
