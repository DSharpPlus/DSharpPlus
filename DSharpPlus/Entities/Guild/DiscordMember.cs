...
public class DiscordMember : DiscordUser, IEquatable<DiscordMember>
{
    ...
    public DiscordVoiceState VoiceState
        => this.Discord._guildIds[this._guild_id].VoiceStates.TryGetValue(this.Id, out DiscordVoiceState? voiceState) ? voiceState : null;
    ...
    public DiscordGuild Guild
        => this.Discord._guildIds[this._guild_id];
