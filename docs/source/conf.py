...
# -*- coding: utf-8 -*-
#
# DSharpPlus documentation build configuration file, created by
...
htmlhelp_basename = 'DSharpPlusdoc'
...
latex_documents = [
    (master_doc, 'DSharpPlus.tex', 'DSharpPlus Documentation',
     'Naamloos, afroraydude, DrCreo, Death, Tiaqoy0, Emzi0767', 'manual'),
]
