...
/// <summary>
/// Represents a dropdown menu from where users can select discord-supplied users and roles.
/// </summary>
public interface IMentionableSelectComponent : IInteractiveComponent
{
    /// <summary>
