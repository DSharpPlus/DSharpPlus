...
/// </summary>
public readonly record struct RestMetricsCollection
{
    /// <summary>
    ...
    /// </summary>
    public ulong SuccessfulRequests { get; init; }

    /// <summary>
    /// The failed requests made during the specified duration.
    /// </summary>
    public ulong FailedRequests => this.TotalRequests - this.SuccessfulRequests;
    ...
    public override readonly string ToString()
    {
        ...
        if (this.FailedRequests > 0)
        {
            ...
            if (this.RatelimitsHit > 0)
            {
                ...
                (
                    CultureInfo.CurrentCulture,
                    $"  - Ratelimits hit: {this.RatelimitsHit} ({Percentage(this.TotalRequests, (ulong)this.RatelimitsHit)})"
                );
                ...
                if (this.GlobalRatelimitsHit > 0)
                {
                    ...
                    (
                        CultureInfo.CurrentCulture,
                        $"    - Global ratelimits hit: {this.GlobalRatelimitsHit} ({Percentage(this.TotalRequests, (ulong)this.GlobalRatelimitsHit)})"
                    );
                }
                ...
                if (this.BucketRatelimitsHit > 0)
                {
                    ...
                    (
                        CultureInfo.CurrentCulture,
                        $"    - Bucket ratelimits hit: {this.BucketRatelimitsHit} ({Percentage(this.TotalRequests, (ulong)this.BucketRatelimitsHit)})"
                    );
                }
            }
            ...
            if (this.BadRequests > 0)
            {
                ...
                (
                    CultureInfo.CurrentCulture,
                    $"  - Bad requests executed: {this.BadRequests} ({Percentage(this.TotalRequests, (ulong)this.BadRequests)})"
                );
            }
            ...
            if (this.Forbidden > 0)
            {
                ...
                (
                    CultureInfo.CurrentCulture,
                    $"  - Forbidden/Unauthorized requests executed: {this.Forbidden} ({Percentage(this.TotalRequests, (ulong)this.Forbidden)})"
                );
            }
            ...
            if (this.NotFound > 0)
            {
                ...
                (
                    CultureInfo.CurrentCulture,
                    $"  - Requests not found: {this.NotFound} ({Percentage(this.TotalRequests, (ulong)this.NotFound)})"
                );
            }
            ...
            if (this.TooLarge > 0)
            {
                ...
                (
                    CultureInfo.CurrentCulture,
                    $"  - Requests too large: {this.TooLarge} ({Percentage(this.TotalRequests, (ulong)this.TooLarge)})"
                );
            }
            ...
            if (this.ServerErrors > 0)
            {
                ...
                (
                    CultureInfo.CurrentCulture,
                    $"  - Server errors: {this.ServerErrors} ({Percentage(this.TotalRequests, (ulong)this.ServerErrors)})"
                );
            }
        }
    ...
    private static string Percentage(ulong total, ulong part)
    {
