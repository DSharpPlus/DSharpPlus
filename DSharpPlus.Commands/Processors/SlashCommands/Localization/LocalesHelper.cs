...
public static class LocalesHelper
{
    ...
    {
        Dictionary<string, DiscordLocale> englishToLocale =
            new()
            {
        ...
        Dictionary<string, DiscordLocale> nativeToLocale =
            new()
            {
        ...
        Dictionary<DiscordLocale, string> localeToEnglish = englishToLocale.ToDictionary(
            x => x.Value,
            x => x.Key
        );
        Dictionary<DiscordLocale, string> localeToNative = nativeToLocale.ToDictionary(
            x => x.Value,
            x => x.Key
        );
