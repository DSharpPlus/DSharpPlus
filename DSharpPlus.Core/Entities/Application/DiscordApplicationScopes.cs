...
{
    public static class DiscordApplicationScopes
    {
        /// <summary>
        ...
        /// <summary>
        /// Allows your app to update a user's activity - requires Discord approval (NOT REQUIRED FOR <see href="https://discord.com/developers/docs/game-sdk/activities">GAMESDK ACTIVITY MANAGER</see>).
        /// </summary>
