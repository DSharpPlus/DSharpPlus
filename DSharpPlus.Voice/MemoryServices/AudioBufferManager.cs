...
/// </summary>
public abstract class AudioBufferManager
{
    // these are provided here as statics to help the JIT with devirtualizing them
    private static readonly MimallocAudioBufferManager backing = new();
    private static readonly OpusSilenceBufferProvider backingSilence = new();

    /// <summary>
    /// A pre-provided pool for opus audio buffers.
    /// </summary>
    public static AudioBufferManager Shared => backing;

    /// <summary>
    /// A pre-provided pool for opus silence frames.
    /// </summary>
    public static AudioBufferManager OpusSilenceFrames => backingSilence;
    ...
    public abstract AudioBufferLease Rent(int count);
    ...
    protected internal abstract unsafe void Return(void* buffer);
}
