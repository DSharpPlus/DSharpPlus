...
namespace DSharpPlus.Net.WebSocket
{
    public class WebSocket4NetCoreClient : BaseWebSocketClient
    {
        ...
        public override Task<BaseWebSocketClient> ConnectAsync(string uri)
        {
            ...
            _socket.MessageReceived += (sender, e) => _message.InvokeAsync(new SocketMessageEventArgs { Message = e.Message }).GetAwaiter().GetResult();
            ...
            _socket.DataReceived += (sender, e) =>
            {
                ...
                _message.InvokeAsync(new SocketMessageEventArgs { Message = msg }).GetAwaiter().GetResult();
            };
