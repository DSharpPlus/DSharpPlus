...
public readonly record struct Result<TValue>
{
    ...
    {
        Expect((error) => new Exception(error.Message));
        return this.Value;
    }
    ...
    /// </summary>
    public Result<TValue> MapError(Func<ResultError, ResultError> transform)
    ...
    /// </summary>
    public Result<TResult> MapOrElse<TResult>(Func<TValue, TResult> transformValue, Func<ResultError, ResultError> transformError)
...
#pragma warning disable CA1000
    ...
    /// </summary>
    public static Result<TValue> FromError(ResultError error) => new(error);
