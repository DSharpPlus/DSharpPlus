...
namespace DSharpPlus.Entities
{
    ...
    public class DiscordWebhook : SnowflakeObject, IEquatable<DiscordWebhook>
    {
        ...
        public Task<DiscordWebhook> ModifyAsync(string name = null, string base64avatar = null) =>
            this.Discord._rest_client.InternalModifyWebhookAsync(this.Id, name, base64avatar, Token);
        ...
        public Task DeleteAsync() => 
            this.Discord._rest_client.InternalDeleteWebhookAsync(this.Id, Token);
