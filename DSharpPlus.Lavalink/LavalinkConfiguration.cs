...
namespace DSharpPlus.Lavalink
{
    ...
    public sealed class LavalinkConfiguration
    {
        ...
        /// </summary>
        public ConnectionEndpoint RestEndpoint { internal get; set; } = new ConnectionEndpoint("127.0.0.1", 80);

        /// <summary>
        /// Sets the endpoint for Lavalink Websocket connection.
        /// </summary>
        public ConnectionEndpoint SocketEndpoint { internal get; set; } = new ConnectionEndpoint("127.0.0.1", 80);
