    ...
    private static void RegisterSerialization(IServiceCollection services)
    {
        ...
        (
            options =>
            {
                ...
                options.AddModel<IContainerComponent, ContainerComponent>();
                options.AddModel<IDefaultSelectValue, DefaultSelectValue>();
                options.AddModel<IFileComponent, FileComponent>();
                options.AddModel<IMediaGalleryComponent, MediaGalleryComponent>();
                options.AddModel<IMediaGalleryItem, MediaGalleryItem>();
                ...
                options.AddModel<ISectionComponent, SectionComponent>();
                options.AddModel<ISelectOption, SelectOption>();
                options.AddModel<ISeparatorComponent, SeparatorComponent>();
                options.AddModel<IStringSelectComponent, StringSelectComponent>();
                options.AddModel<ITextDisplayComponent, TextDisplayComponent>();
                options.AddModel<ITextInputComponent, TextInputComponent>();
                options.AddModel<IThumbnailComponent, ThumbnailComponent>();
                options.AddModel<IUnfurledMediaItem, UnfurledMediaItem>();
                ...
                options.AddModel<IIncidentsData, IncidentsData>();
