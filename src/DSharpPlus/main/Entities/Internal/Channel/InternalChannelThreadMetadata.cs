...
namespace DSharpPlus.Core.Entities
{
    ...
    public sealed record InternalChannelThreadMetadata
    {
        ...
        public InternalThreadAutoArchiveDuration AutoArchiveDuration { get; init; }
        ...
        /// <summary>
        /// Whether the thread is locked; when a thread is locked, only users with <see cref="InternalPermissions.ManageThreads"/> can unarchive it.
        /// </summary>
