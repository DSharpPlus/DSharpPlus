...
public sealed partial class DiscordShardedClient
{
    ...
    private Task MessageAcknowledgedDelegator(DiscordClient client, MessageAcknowledgeEventArgs eventArgs) => _messageAcknowledged.InvokeAsync(client, eventArgs);
    ...
    private DiscordShardedClient()
    {
        ...
        _messageAcknowledged = new("MESSAGE_ACKNOWLEDGED", EventErrorHandler);
