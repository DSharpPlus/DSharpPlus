...
{
    /// <summary>
    /// The voice server should respond with an <see cref="Enums.InternalVoiceOpCode.Ready"/> payload, which informs us of the SSRC, UDP IP/port, and supported encryption modes the voice server expects.
    /// </summary>
    public sealed record InternalVoiceReadyPayload
    {
